...
exports.NetworkModule = NetworkModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [network_service_1.NetworkService, network_repository_1.NetworkRepository],
        exports: [network_service_1.NetworkService, network_repository_1.NetworkRepository],
    })
], NetworkModule);
