...
let CommissionsController = class CommissionsController {
    ...
    async me(user, status, page, limit) {
        const result = await this.commissionsService.findMyCommissions(user.sub, status, page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 20);
...
__decorate([
    (0, common_1.Get)('me'),
    (0, swagger_1.ApiOperation)({ summary: 'Minhas comissoes' }),
...
], CommissionsController.prototype, "me", null);
__decorate([
    (0, common_1.Get)('me/balance'),
    (0, swagger_1.ApiOperation)({ summary: 'Saldo disponivel (pending)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CommissionsController.prototype, "balance", null);
__decorate([
    (0, common_1.Get)('me/pending'),
    (0, swagger_1.ApiOperation)({ summary: 'Comissoes pendentes para saque' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CommissionsController.prototype, "pending", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Comissao por ID' }),
