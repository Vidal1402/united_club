...
exports.JourneyModule = JourneyModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [journey_service_1.JourneyService, journey_repository_1.JourneyRepository],
        exports: [journey_service_1.JourneyService, journey_repository_1.JourneyRepository],
    })
], JourneyModule);
