...
let NotificationsController = class NotificationsController {
    ...
    async me(user, unreadOnly, page, limit) {
        const result = await this.notificationsService.findMyNotifications(user.sub, unreadOnly === 'true', page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 20);
...
__decorate([
    (0, common_1.Get)('me'),
    (0, swagger_1.ApiOperation)({ summary: 'Minhas notificacoes' }),
